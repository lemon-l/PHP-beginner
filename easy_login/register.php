<?php
$link=mysql_connect("localhost","root","jsjl246jsjl?");//链接数据库
    ...
    if($select)
    {
      ...
      if(isset($_POST["sub"]))
      {
        ...
        if($name==""||$password1=="")//判断是否填写
        {
          ...
          echo"<script type="."\""."text/javascript"."\"".">"."window.location="."\""."http://127.0.0.1:9096/project/register.html"."\""."</script>";    
          exit;
        }
        if($password1==$password2)//确认密码是否正确
        {
            ...
            //echo"数据库关闭";
            //echo"注册成功！";
            echo"<script type="."\""."text/javascript"."\"".">"."window.location="."\""."http://127.0.0.1:9096/project/return.html"."\""."</script>";    
            }
        }
        else
        {
